...
public class ActiveAppointmentsAdapter extends RecyclerView.Adapter<ActiveAppointmentsAdapter.MyViewHolder> {
    private ArrayList<Reminder> arrayList;
    private Context context;
    public ActiveAppointmentsAdapter(Context context,ArrayList<Reminder>arrayList)
    {
...
//    hiiiiiii
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_appointmentlist,parent,false);
...
//        holder.interval.setText(interval);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            Appointmentname= (TextView) itemView.findViewById(R.id.Appointmentname);
            time= (TextView) itemView.findViewById(R.id.Appointmenttime);
            date= (TextView) itemView.findViewById(R.id.AppointmentDate);
            description= (TextView) itemView.findViewById(R.id.Appointment_Description);
            status= (TextView) itemView.findViewById(R.id.Statusapointment);
            imageView= (ImageView) itemView.findViewById(R.id.Statusapointment_image);
            Dhead= (TextView) itemView.findViewById(R.id.AppointmentDateHead);
            THead= (TextView) itemView.findViewById(R.id.AppointmenttimeHead);
        }
    }
}
