...
public class ExpiredAppointmentsAdapter extends RecyclerView.Adapter<ExpiredAppointmentsAdapter.MyHolder> {
    private ArrayList<Reminder> arrayList;
    private Context context;
    public ExpiredAppointmentsAdapter(Context context,ArrayList<Reminder>arrayList)
    {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.inflateexpired_appointmentlist,parent,false);
...
//        holder.interval.setText(interval);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        TextView name,time,date,description,status;
        ImageView imageView;
        TextView Dhead,THead;
        public MyHolder(View itemView) {
            super(itemView);
            name= (TextView) itemView.findViewById(R.id.AppointmentnameEx);
            time= (TextView) itemView.findViewById(R.id.AppointmenttimeEx);
            date= (TextView) itemView.findViewById(R.id.AppointmentDateEx);
            description= (TextView) itemView.findViewById(R.id.Appointment_DescriptionEx);
            status= (TextView) itemView.findViewById(R.id.StatusapointmentEx);
            imageView= (ImageView) itemView.findViewById(R.id.StatusapointmentEx_image);
            Dhead= (TextView) itemView.findViewById(R.id.ExAppointmentDateHead);
            THead= (TextView) itemView.findViewById(R.id.ExAppointmenttimeHead);
        }
    }
}
