...
public class ActiveListFragment extends BaseFragment {
 ...
 private ArrayList<Reminder>arrayList;
    ...
    private ActiveReminderAdapter adapter;
    DataSource db;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.activereminderlistfragment,null);
        initui(v);
    ...
    private void setRecyclerView() {
        adapter = new ActiveReminderAdapter(getActivity(), reverse);
        recyclerView.setAdapter(adapter);
    }

    private void initui(View v) {
        recyclerView = (RecyclerView) v.findViewById(R.id.recycleview_viewReminderlist);
