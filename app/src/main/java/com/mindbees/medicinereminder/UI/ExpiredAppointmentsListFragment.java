...
import com.mindbees.medicinereminder.Adapters.ExpiredAppointmentsAdapter;
...
public class ExpiredAppointmentsListFragment extends BaseFragment{
    private RecyclerView recyclerView;
    private ArrayList<Reminder> arrayList;
    private ArrayList<Reminder>exlist;
    private ArrayList<Reminder>reverse;
    private ExpiredAppointmentsAdapter adapter;
    DataSource db;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.expiredppintmentlistfragment,null);
        initui(v);
    ...
    private void setRecyclerView() {
        adapter = new ExpiredAppointmentsAdapter(getActivity(), reverse);
        recyclerView.setAdapter(adapter);
    }

    private void initui(View v) {
        recyclerView = (RecyclerView) v.findViewById(R.id.recycleview_ExpiredAppointmentList);
