...
public class ActiveAppointmentsListFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.active_appointments_list,null);
        initui(v);
    ...
    private void setRecyclerView() {
        adapter = new ActiveAppointmentsAdapter(getActivity(), reverse);
        recyclerView.setAdapter(adapter);
    }

    private void initui(View v) {
        recyclerView = (RecyclerView) v.findViewById(R.id.recycleview_viewAppointmentlist);
    ...
    private void initListner() {
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                ...
                args.putInt("Id", id);
                args.putInt(Constants.FRAGMENT_REMINDER_TYPE,1);
