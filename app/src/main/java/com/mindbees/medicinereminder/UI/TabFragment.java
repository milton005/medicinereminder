...
public class TabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View ex = inflater.inflate(R.layout.tablayout, null);
        tabLayout = (TabLayout) ex.findViewById(R.id.tabs);



        viewPager = (ViewPager) ex.findViewById(R.id.viewpager);

        viewPager.setAdapter(new MyAdapter(getChildFragmentManager()));

        getActivity().setTitle("Pill Reminder");
...
//        ActiveTitle="Active "+"("+activeno+")";
        ...
        FloatingActionButton fab = (FloatingActionButton) ex.findViewById(R.id.fab);
...
//                tabLayout.getTabAt(0).setCustomView(R.layout.bdged_tab);
            }
        });
        try
        {
...
//                    }, 50);
    ...
    private class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
               case 0 : return new All_Reminder_Fragment();
                case 1 : return new ActiveListFragment();
                case 2:return new ExpiredListFragment();
